...
//Created to customize menu items to add bootstrap classes
...
/* Bootstrap_Walker for Wordpress 
     ...
     *  
     */ 
class Bootstrap_Walker_Nav_Menu extends Walker {
	/**
	 * What the class handles.
	 *
	 * @see Walker::$tree_type
 ...
 */
function wp_nav_menu( $args = array( 'container_class' => 'test') ) {
